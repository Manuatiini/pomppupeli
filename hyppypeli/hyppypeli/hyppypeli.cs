...
public class hyppypeli : PhysicsGame
{
    ...
    void lisaamörkö(Vector paikka, double leveys, double korkeus)
    {
        ...
        AddCollisionHandler(morko, TormasiEsteeseen);
    }
    ...
    private void LisaaPelaaja(Vector paikka, double leveys, double korkeus)
    {
        ...
        Add(pelaaja1);
        AddCollisionHandler(pelaaja1, Tormaatahteen);
    ...
    void LisaaNappaimet()
    {
        ...
        ControllerOne.Listen(Button.DPadLeft, ButtonState.Down, Liikuta, "Pelaaja liikkuu vasemmalle", pelaaja1,
            -NOPEUS);
        ControllerOne.Listen(Button.DPadRight, ButtonState.Down, Liikuta, "Pelaaja liikkuu oikealle", pelaaja1,
            NOPEUS);
    ...
    private void Tormaatahteen(PhysicsObject pelaaja1, PhysicsObject kohde)
    {
        if (kohde.Tag == "tahti")
        {
            maaliAani.Play();
            MessageDisplay.Add("wow tähti!");
            kohde.Destroy();
        }
